...
- **FR-03.1**: Bedrock Claude 4 Sonnet으로 리뷰를 카테고리별 분류한다 (vote failure, ads issue, login/account, points/rewards, crash/performance, trust/fairness, translation/localization)
